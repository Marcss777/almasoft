<template>
  <div style="background-color: #2E2E2E; min-height: 100vh; width: 100%;">
    ...
    <div style="padding: 16px 30px;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <div>
          <h1 style="font-size: 34px; font-weight: 600; color: white; margin: 0;">Productos</h1>
          <p style="font-size: 18px; color: #ffffff; margin: 2px 0 0 0; font-weight: 300;">Gestiona tu inventario de productos de manera eficiente.</p>
        </div>
        
        <button onclick="window.location.href='/productos/crear-productos'" style="background-color: #d6f277; color: #222222; border: none; border-radius: 10px; padding: 8px 15px; font-size: 15px; font-weight: 600; display: flex; align-items: center; cursor: pointer; font-family: 'Poppins', sans-serif;">
        ...
        <div style="padding: 14px;">
          <div style="display: flex; gap: 10px; align-items: center;">
            ...
            <div style="position: relative; width: 225px;">
              <select style="width: 100%; padding: 9px 42px 10px 16px; appearance: none; background-color: #2A2A2A; border: 1px solid #3B3B3B; border-radius: 10px; color: white; font-size: 15px; outline: none; cursor: pointer; font-family: 'Poppins', sans-serif;">
      ...
      <div style="background-color: #333333; border-radius: 10px; border: 1px solid #3B3B3B;">
        <div style="padding: 15px; border-bottom: 1px solid #3B3B3B; display: flex; justify-content: space-between; align-items: center;">
          <h2 style="font-size: 16px; color: white; margin: 0; font-weight: 600;">Listado de productos</h2>
  ...
  <thead>
    <tr style="background-color: #2A2A2A; text-align: left;">
      ...
      <th style="padding: 12px 15px; font-size: 14px; font-weight: 500; color: white; border-bottom: 1px solid #3B3B3B; width: 390px;">Nombre</th>
      <th style="padding: 12px 15px; font-size: 14px; font-weight: 500; color: white; border-bottom: 1px solid #3B3B3B; width: 190px;">Categoría</th>
      <th style="padding: 12px 15px; font-size: 14px; font-weight: 500; color: white; border-bottom: 1px solid #3B3B3B; width: 100px;">Stock</th>
      <th style="padding: 12px 15px; font-size: 14px; font-weight: 500; color: white; border-bottom: 1px solid #3B3B3B; width: 150px;">Precio</th>
      <th style="padding: 12px 15px; font-size: 14px; font-weight: 500; color: white; border-bottom: 1px solid #3B3B3B; text-align: center;">Acciones</th>
    </tr>
  </thead>

  <!-- Cuerpo de la tabla -->
  <tbody>
    <tr v-for="p in productos" :key="p.id" style="background-color: #333333; color: white; border-bottom: 1px solid #3B3B3B;">
      <td style="padding: 12px 15px; font-size: 14px; width: 50px;">{{ p.id }}</td>
      <td style="padding: 12px 15px; font-size: 14px; width: 390px;">{{ p.nombre }}</td>
      <td style="padding: 12px 15px; font-size: 14px; width: 190px;">{{ p.categoria }}</td>
      <td style="padding: 12px 15px; font-size: 14px; width: 100px;">{{ p.stock }}</td>
      <td style="padding: 12px 15px; font-size: 14px; width: 150px;">${{ p.precio }}</td>
      <td style="padding: 12px 15px; font-size: 14px; display: flex; gap: 10px; justify-content: center;">
        <!-- Botón de editar -->
<button :onclick="`window.location.href='/productos/editar-productos/${p.id}'`" 
  style="background: #2A2A2A; border: 1px solid #3B3B3B; cursor: pointer; width: 100px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; border-radius: 8px;">
 <span style="display: inline-flex; width: 20px; height: 20px;">
        ...
        <!-- Botón de eliminar -->
        <button @click="eliminar(p.id)" style="background: #2A2A2A; border: 1px solid #3B3B3B; cursor: pointer; width: 100px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; border-radius: 8px;">
          <span style="display: inline-flex; width: 20px; height: 20px;">
...
export default {
  ...
  methods: {
    ...
    async eliminar(id) {
      await axios.delete(`http://localhost:4000/producto/eliminar/${id}`);
      this.cargar();
    }
  },
  mounted() {
